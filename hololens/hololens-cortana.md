...
> [!NOTE]
> Die Spracherkennung wird nur in [einigen Sprachen](hololens2-language-support.md)unterstützt. Die für die Spracherkennung verwendete Sprache basiert auf der Windows-Anzeigesprache, nicht auf der Tastatursprache.  
>  
...
| Sagen Sie das | Aufgabe |
| - | - |
| „Gerät neu starten“ | Rufen Sie ein Dialogfeld auf, um zu bestätigen, dass Sie das Gerät neu starten möchten. Um neu zu starten, können Sie „Ja“ sagen. |
| „Gerät herunterfahren“ | Rufen Sie ein Dialogfeld auf, um zu bestätigen, dass Sie das Gerät ausschalten möchten. Zur Bestätigung können Sie „Ja“ sagen. |
| „Heller/dunkler“ | Erhöhen oder verringern Sie die Anzeigehelligkeit um 10 %. |
| „Lauter/leiser“ | Erhöhen oder verringern Sie die Lautstärke um 10 %. |
| „Wie lautet meine IP?“ | Rufen Sie ein Dialogfeld auf, das die aktuelle IP-Adresse Ihres Computers im lokalen Netzwerk anzeigt. |
| „Bild aufnehmen“ | Nehmen Sie ein Mixed-Reality-Bild von dem auf, was Sie gerade sehen. |
...
| „Kleiner“ | Verkleinern |
| „Zu mir drehen“ | Zu Ihnen drehen |
| „Verschieben“ | Verschieben (Ihrem Blick folgen) |
| „Schließen“ | Schließen |
...
Die Diktierfunktion von HoloLens verwendet explizite Interpunktion. Dies bedeutet, dass Sie den Namen des zu verwendenden Satzzeichens sagen. Sie können beispielsweise Folgendes sagen: „Hallo **Komma** was machst du gerade **Fragezeichen**“.
...
Im Folgenden finden Sie einige Sprachbefehle, die Sie ausprobieren können (denken Sie daran, zuerst „Hey Cortana“ zu sagen).
...
Wenn Sie *Version 18362.x oder früher* nutzen, können Sie auch die folgenden Befehle verwenden:

**Hallo, Cortana**...

- Increase the volume (erhöhe die Lautstärke).
- Decrease the brightness (verringere die Helligkeit).
- Shut down (herunterfahren).
- Restart (neu starten).
- Go to sleep (Ruhezustand).
- Stummschalten.
- <*app name*> hierher verschieben (visieren Sie die Stelle an, an die Sie die App verschieben möchten).
- Zum Startmenü
- Take a picture (Bild aufnehmen).
- Start recording (Aufzeichnung starten. (Beginnt die Aufzeichnung eines Videos.)
