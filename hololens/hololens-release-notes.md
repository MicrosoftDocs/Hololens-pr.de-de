...
- Es wurde ein Problem behobenWi-Fi bei dem der Wi-Fi-Proxy nicht gespeichert werden kann, wenn die Wi-Fi-Eigenschaftenbenutzeroberfläche von **Einstellungen -> Network & Internet -> Status -> Properties gestartet wurde.**
...
### <a name="onedrive-for-work-or-school-camera-roll-upload"></a>OneDrive Für Arbeits-, Schul- oder Schul-/Schulkamerarollup

Wir haben der HoloLens 2 Einstellungen-App ein neues Feature hinzugefügt, mit dem Kunden automatisch Mixed Reality-Fotos und -Videos aus dem Ordner Pictures > Camera Roll des Geräts in den entsprechenden ordner OneDrive for work oder school hochladen können. Dieses Feature behebt eine Featurelücke innerhalb der [OneDrive-App](holographic-photos-and-videos.md#share-your-mixed-reality-photos-and-videos) auf HoloLens 2, die nur den automatischen Upload der Kamerarolle in die persönliche Microsoft-Konto eines Kunden (und nicht in sein Arbeits-, Schul- oder Schulkonto) unterstützt.
...
- Diese Einstellung verfügt nicht über eine integrierte Drosselung basierend auf der aktuellen Bandbreitennutzung. Wenn Sie die Bandbreite für ein anderes Szenario maximieren müssen, deaktivieren Sie die Einstellung manuell. Hochladen wird angehalten, aber das Feature überwacht weiterhin neu hinzugefügte Dateien zu Camera Roll. Aktivieren Sie den Upload erneut, wenn Sie bereit sind, ihn fortzufahren.
...
- Behebung eines Arbeitsspeicherverlusts im Geräteportal Service. Das Problem führte zu einer erhöhten Speicherauslastung durch den Dienst, was dazu führte, dass andere Anwendungen nicht genügend Arbeitsspeicher zuordnen.
...
- Es wurde ein Problem behoben, bei dem die PIN-Azure AD konten den Fehler "Etwas ist schief gelaufen.
...
| [Aktivierte Einstellungen Seitensichtbarkeit für HoloLens 2](hololens-release-notes.md#enabled-settings-page-visibility-for-hololens-2)      | Richtlinie zum Auswählen, welche Seiten in der App angezeigt Einstellungen werden.             |
...
Weitere Informationen zum automatischen Starten der [Bereitstellung über einen USB-Speicher](hololens-provisioning.md#auto-launch-provisioning-from-usb) finden Sie in der HoloLens Bereitstellungsdokumentation.
...
- Die Notwendigkeit von USB-C-Adaptern zu Ethernet wurde beseitigt, wodurch die Hardwareanforderungen reduziert wurden, da Autopilot auf Wi-Fi verbundenen Geräten funktionieren kann.
...
Zuvor wurden Fehler beim Anwenden des Kioskmodus HoloLens verwendet, um alle Anwendungen im Startmenü anzuzeigen. Nun werden in Windows Holographic Version 20H2 bei Ausfällen keine Apps im Startmenü angezeigt, wie unten dargestellt: 
...
Wir haben nun eine Richtlinie aktiviert, die IT-Administratoren ermöglicht, entweder zu verhindern, dass bestimmte Seiten in der System Einstellungen-App sichtbar oder zugänglich sind, oder dies für alle Seiten mit Ausnahme der angegebenen Seiten zu tun. Klicken Sie auf den folgenden Link, um zu erfahren, wie Sie dieses Feature vollständig anpassen.
...
|       Anwendungsinstallationsstatus                 |          Überprüfen des Installationsstatus in der Einstellungen-App für Apps, die per MDM an HoloLens 2 gepusht wurden               |
