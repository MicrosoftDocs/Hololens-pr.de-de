...
| [Verbesserungen bei der Protokollsammlung mit geringem Speicher](#low-storage-log-collection-improvements) | Verbesserungen an Protokollsammlungsszenarien in Situationen mit wenig Speicher. | IT-Administrator | 20348.1412 |
| [Verschieben des Plattformmodus](#moving-platform-mode) | Führt die Betaversion des Moving Platform-Modus ein, die bei der Konfiguration die Verwendung von HoloLens 2 bei großen 1600-1600-Euro ermöglicht, die eine geringe dynamische Bewegung aufweisen. | Alle | 20348.1411 |
...
Wählen Sie dann **Aktive Entwicklung von** Windows aus, wählen Sie aus,  ob Sie Dev **Channel** oder Betakanal erhalten möchten, und überprüfen Sie die Programmbegriffe.
...
Wenn beim Aktualisieren auf dem Dev- oder Betakanal 0x80070490 Updatefehler auftritt, versuchen Sie, die folgenden kurzfristigen Schritte zu unternehmen. Dazu gehört das Verschieben Ihres Insiderkanals, das Aufnehmen des Updates und das anschließende Verschieben Des Insider-Kanals zurück.
...
Wenn Sie keine Insider-Builds von Windows Holographic mehr erhalten möchten, können Sie sich abmelden, [](hololens-recovery.md) wenn ihre HoloLens einen Produktions build ausgeführt, oder Sie können Ihr Gerät mit dem Advanced Recovery Companion wiederherstellen, um Ihr Gerät auf eine nicht-Insider-Version von Windows Holographic wiederhergestellt.
...
1. Wechseln Sie HoloLens einem Produktions-Build zu Einstellungen > **Update & Security > Windows Insider Program,** und wählen Sie Stop Insider builds **(Insider-Builds beenden) aus.**
