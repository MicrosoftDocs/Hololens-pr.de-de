...
2. **Kioskmodus** für mehrere Apps: Startmenü zeigt nur die Anwendungen an, die bei der Benutzeranmeldung in der Kioskkonfiguration angegeben wurden. Eine App kann bei Bedarf automatisch gestartet werden. <br> *Beispiel verwendet*: Ein Gerät, das nur die Store App, Feedback-Hub und Einstellungen App im Startmenü anzeigt.
...
4. Bestimmen Sie, ob der Kioskmodus entweder über Laufzeitbereitstellungspakete oder mobile Geräteverwaltung -Server (MDM) auf HoloLens angewendet wird.
