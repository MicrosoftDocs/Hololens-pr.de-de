...
ms.locfileid: "114991422"
---
# <a name="manage-user-identity-and-sign-in-for-hololens"></a>Verwalten der Benutzeridentität und Anmeldung für HoloLens

> [!NOTE]
> Dieser Artikel ist eine technische Referenz für IT-Spezialisten und Technologieinteressierte. Wenn Sie nach HoloLens Anweisungen suchen, lesen Sie "[Setting up your HoloLens (1st gen)](hololens1-start.md)" oder " Setting up your[HoloLens 2](hololens2-start.md)".

Wie andere Windows Geräte wird HoloLens immer unter einem Benutzerkontext betrieben. Es gibt immer eine Benutzeridentität. HoloLens behandelt Identitäten fast genauso wie andere Windows Geräte. Dieser Artikel ist eine umfassende Referenz zur Identität auf HoloLens und konzentriert sich darauf, wie sich HoloLens von anderen Windows Geräten unterscheidet.

HoloLens unterstützt verschiedene Arten von Benutzeridentitäten. Sie können sich mit einem oder mehreren Benutzerkonten anmelden. Hier finden Sie eine Übersicht über die Identitätstypen und Authentifizierungsoptionen auf HoloLens:
...
Wenn Sie sich mit einem Unternehmens- oder Organisationskonto bei HoloLens anmelden, werden HoloLens in der IT-Infrastruktur der Organisation registriert. Mit dieser Registrierung kann Ihr IT-Administrator Mobile Geräteverwaltung (MDM) so konfigurieren, dass Gruppenrichtlinien an Ihre HoloLens gesendet werden.
...
In [Windows Holographic, Version 21H1 eingeführt,](hololens-release-notes.md#windows-holographic-version-21h1)werden auf dem Anmeldebildschirm mehrere Benutzer angezeigt, die sich zuvor beim Gerät angemeldet haben, wenn Sie **Andere Benutzer** auswählen, die sich rechts neben dem PIN-Eingabefeld befinden. Dadurch können Benutzer ihr Benutzerprofil auswählen und sich dann mit ihren Windows Hello Anmeldeinformationen anmelden. Ein neuer Benutzer kann dem Gerät auch auf dieser Seite Andere Benutzer über die Schaltfläche **Konto hinzufügen** hinzugefügt werden.
...
Sie können einen Benutzer vom Gerät entfernen, indem Sie zu **Einstellungen**  >  **Konten**  >  **Andere Personen** gehen. Diese Aktion gibt auch Speicherplatz frei, indem alle App-Daten dieses Benutzers vom Gerät entfernt werden.  
...
HoloLens 2 unterstützt die Iris-Authentifizierung. Iris basiert auf Windows Hello Technologie und wird sowohl von Azure Active Directory als auch von Microsoft-Konten unterstützt. Iris wird auf die gleiche Weise wie andere Windows Hello-Technologien implementiert und erreicht [biometrische Sicherheit far von 1/100.000](/windows/security/identity-protection/hello-for-business/hello-biometrics-in-enterprise#has-microsoft-set-any-device-requirements-for-windows-hello).
...
Ja, Sie können sie manuell in Einstellungen entfernen.
...
Weitere Informationen zum Schutz und zur Authentifizierung von Benutzeridentitäten finden [Sie in der Dokumentation zu sicherheit und identitätsbasierten Windows 10](/windows/security/identity-protection/).
