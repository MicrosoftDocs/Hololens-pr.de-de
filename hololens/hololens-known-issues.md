...
ms.locfileid: "112923549"
---
# <a name="known-issues-for-hololens-1st-gen"></a>Bekannte Probleme bei HoloLens (1. Generation)

Hier ist die aktuelle Liste bekannter Probleme für HoloLens-Geräte. Überprüfen Sie hier zuerst, ob ein ungewöhnliches Verhalten auftritt. Diese Liste wird aktualisiert, wenn neue Probleme erkannt oder gemeldet werden oder wenn Probleme in zukünftigen HoloLens-Softwareupdates behoben werden.
...
Visual Studio hat VS 2019 Version 16.2 veröffentlicht, die eine Lösung für dieses Problem enthält. Es wird empfohlen, auf diese neueste Version zu aktualisieren, um zu vermeiden, dass dieser Fehler auftritt.
...
1. Vergewissern Sie sich, dass Ihr Gerät entsperrt ist.  Wenn Sie dies noch nicht getan haben, finden Sie anweisungen unter [Verwenden der Windows-Geräteportal.](https://docs.microsoft.com/windows/mixed-reality/using-the-windows-device-portal)
